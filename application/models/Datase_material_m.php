<?php
	...
	* 
	*/
	class datase_material_m extends CI_Model
	{
		...
		public function getAll(){
			$query	= $this->db->get('datase_material');
		...
		public function insertData($dataarray){
		    ...
		    $this->db->insert('datase_material', $data);
		    }
     	}

     	public function ubah($datase_material){
     		$this->db->where('no_rec', $this->getNo_rec());
     		$query	= $this->db->update('datase_material', $datase_material);
     	...
     	public function hapus(){
     		$this->db->where('no_rec', $this->getNo_rec());
     		$query 	= $this->db->delete('datase_material');
